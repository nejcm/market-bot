...
Observed price: 198.5 USD; price as of fetch time 2026-06-15T14:30:00.000Z. [market-yahoo-equity-ifrssa]
...
- IFRSSA has deterministic market and verified close evidence. [market-yahoo-equity-ifrssa] [verified-snapshot-IFRSSA]

## Risks

- Current structured SEC normalization does not support the fixture filing forms. [market-yahoo-equity-ifrssa]
...
- **Material:** sec-edgar: IFRSSA files as a foreign private issuer \(20-F, 6-K\); these forms are not yet supported
...
Fixture IFRS Semiannual plc synthetic FPI fixture replayed through current equity research stages.
...
Cash and debt amounts in USD; diluted shares are weighted-average shares. [extended-sec-edgar-ifrssa-fundamentals]
...
- **Reference:** IFRSSA remains within the deterministic fixture evidence envelope. [market-yahoo-equity-ifrssa]

### Business Framework

Phase: operating-leverage

- **Moat** (criteria-supported): Moat criteria-supported \(Gross margin 85.0%, Operating margin 70.0%\) [extended-sec-edgar-ifrssa-fundamentals]
- **Management** (insufficient-data): Management insufficient-data
- **Risk** (criteria-supported): Risk criteria-supported \(Debt/market cap 18.8%\) [extended-sec-edgar-ifrssa-fundamentals] [market-yahoo-equity-ifrssa] [verified-snapshot-IFRSSA]
- **Valuation** (criteria-not-supported): Valuation criteria-not-supported \(Trailing PE 31.00x, Forward PE 28.00x, EV/revenue 15.33x\) [market-yahoo-equity-ifrssa] [extended-sec-edgar-ifrssa-fundamentals]
...
- No prior ticker runs found for IFRSSA
