...
- The fixture includes a provider-estimated earnings event and options reference bar. [extended-finnhub-events-aapl] [extended-tradier-earnings-implied-move-aapl]
...
- **Upcoming earnings:** AAPL on 2026-07-10 (amc; provider-estimated) [extended-finnhub-events-aapl]
...
- **Material:** earningsForecastGate: earnings-return predictions suppressed because the event date is provider-estimated; official issuer or direct exchange confirmation is required
...
- **Material:** predictionShortfall: emitted 0 of 5 target predictions; evidence did not support more
...
**Event:** AAPL earnings on 2026-07-10 (timing: amc) — date provider-estimated (Finnhub), unconfirmed
**Implied move:** ±3.5% (ATM strike 200, expiration 2026-07-17)

#### Expectation Bar

- The deterministic fixture records the provider estimate and options reference bar.[extended-finnhub-events-aapl] [extended-tradier-earnings-implied-move-aapl]
...
- 19 diagnostic data gaps; see the Research Console Advanced view or report.json for details.
...
- [news-equity-1] Apple fixture provider update
