...
- 22 diagnostic data gaps; see the Research Console Advanced view or report.json for details.
...
- 6 uncited normalized source(s) omitted from markdown (yahoo/market-data:6). Full source arrays remain in report.json and console files.
